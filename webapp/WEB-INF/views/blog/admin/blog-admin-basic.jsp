	...
	<div id="wrap">
		...
		<div id="content">
			...
			<div id="admin-content">
				<form action="${pageContext.request.contextPath}/${bMap.ID}/admin/basic/update" method="post" enctype="multipart/form-data">
	 		      	<table id="admin-basic">
			      		...
			      		<tr>
			      			...
			      			<td class="text-left"><img src="${pageContext.request.contextPath}/assets/images/${bMap.LOGOFILE}"></td>   
			      		</tr>      		
			      		<tr>
			      			<td>&nbsp;</td>
